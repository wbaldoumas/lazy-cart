...
public sealed class LazyCartesianProductSextupleArityPropertyTests
{
    ...
    private readonly ILazyCartesianProduct<int, string, double, char, bool, float>? _subjectUnderTest;

    public LazyCartesianProductSextupleArityPropertyTests()
    {
        ...
        _set6 = Enumerable.Range(1, 100).Select(i => i * 0.1f).ToList();
        ...
        NonNegativeInt item6)
    {
        ...
        result.Should().BeInRange(
            0,
            _set1!.Count * _set2!.Count * _set3!.Count * _set4!.Count * _set5!.Count * _set6!.Count - 1
        );
    }
    ...
    {
        if (sampleSize.Get < _set1!.Count * _set2!.Count * _set3!.Count * _set4!.Count * _set5!.Count * _set6!.Count)
        {
