...
/// <summary>
///    Represents a Cartesian product of six sets.
/// </summary>
/// <typeparam name="T1">The type of the first set.</typeparam>
/// <typeparam name="T2">The type of the second set.</typeparam>
/// <typeparam name="T3">The type of the third set.</typeparam>
/// <typeparam name="T4">The type of the fourth set.</typeparam>
/// <typeparam name="T5">The type of the fifth set.</typeparam>
/// <typeparam name="T6">The type of the sixth set.</typeparam>
public interface ILazyCartesianProduct<T1, T2, T3, T4, T5, T6> : ILazyCartesianProduct
{
    /// <summary>
    ///     Returns the Cartesian product entry at the given index.
    /// </summary>
    ...
    /// <exception cref="ArgumentOutOfRangeException">Thrown if the index is out of range.</exception>
    /// <returns>The Cartesian product entry at the given index.</returns>
    (T1, T2, T3, T4, T5, T6) this[BigInteger index] { get; }
    ...
    /// <exception cref="ArgumentOutOfRangeException">Thrown if the index is out of range.</exception>
    /// <returns>The Cartesian product entry at the given index.</returns>
    (T1, T2, T3, T4, T5, T6) AtIndex(BigInteger index);
    ...
    /// <exception cref="ArgumentOutOfRangeException">Thrown if the Cartesian product entry is not found.</exception>
    /// <returns>The index of the given Cartesian product entry.</returns>
    BigInteger IndexOf((T1, T2, T3, T4, T5, T6) entry);
    ...
    /// <exception cref="ArgumentOutOfRangeException">Thrown if <paramref name="sampleSize"/> is greater than <see cref="ILazyCartesianProduct.Size"/>.</exception>
    /// <returns>An evenly-distributed, random sample of Cartesian product entries.</returns>
    IEnumerable<(T1, T2, T3, T4, T5, T6)> GenerateSamples(BigInteger sampleSize);
}

/// <summary>
///    Represents a Cartesian product of seven sets.
/// </summary>
/// <typeparam name="T1">The type of the first set.</typeparam>
/// <typeparam name="T2">The type of the second set.</typeparam>
/// <typeparam name="T3">The type of the third set.</typeparam>
...
/// <typeparam name="T5">The type of the fifth set.</typeparam>
/// <typeparam name="T6">The type of the sixth set.</typeparam>
/// <typeparam name="T7">The type of the seventh set.</typeparam>
public interface ILazyCartesianProduct<T1, T2, T3, T4, T5, T6, T7> : ILazyCartesianProduct
{
    /// <summary>
    ///     Returns the Cartesian product entry at the given index.
    /// </summary>
    ...
    /// <exception cref="ArgumentOutOfRangeException">Thrown if the index is out of range.</exception>
    /// <returns>The Cartesian product entry at the given index.</returns>
    (T1, T2, T3, T4, T5, T6, T7) this[BigInteger index] { get; }
    ...
    /// <exception cref="ArgumentOutOfRangeException">Thrown if the index is out of range.</exception>
    /// <returns>The Cartesian product entry at the given index.</returns>
    (T1, T2, T3, T4, T5, T6, T7) AtIndex(BigInteger index);
    ...
    /// <exception cref="ArgumentOutOfRangeException">Thrown if the Cartesian product entry is not found.</exception>
    /// <returns>The index of the given Cartesian product entry.</returns>
    BigInteger IndexOf((T1, T2, T3, T4, T5, T6, T7) entry);
    ...
    /// <exception cref="ArgumentOutOfRangeException">Thrown if <paramref name="sampleSize"/> is greater than <see cref="ILazyCartesianProduct.Size"/>.</exception>
    /// <returns>An evenly-distributed, random sample of Cartesian product entries.</returns>
    IEnumerable<(T1, T2, T3, T4, T5, T6, T7)> GenerateSamples(BigInteger sampleSize);
}
